                      ...
                      <div class="col-md-5 bg-white sign-in-page-data">
                          <div class="sign-in-from">
                              ...
                              <form class="mt-4" method="POST" action="{{ route('verification.send') }}">
                                @csrf
                                  <div class="sign-info text-center">
                                      <button type="submit" class="btn btn-primary d-block w-100 mb-2">Send Verification Email</button>
                                  </div>
                              </form>
                              ...
                              <form class="mt-4" method="POST" action="{{ route('logout') }}">
                                @csrf
                                  <div class="sign-info text-center">
                                      <button type="submit" class="btn btn-primary d-block w-100 mb-2">Logout</button>
                                  </div>
                              </form>
