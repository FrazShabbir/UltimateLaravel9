                    ...
                    <div class="row m-0">
                              ...
                              <form class="mt-4" method="POST" action="{{ route('password.confirm') }}">
                                @csrf
                                  ...
                                  <div class="sign-info text-center">
                                      <button type="submit" class="btn btn-primary d-block w-100 mb-2">Confirm Password</button>
                      ...
                      <div class="col-md-7 text-center sign-in-page-image">
                          <div class="sign-in-detail text-white">
                            <a class="sign-in-logo mb-5" href="#"><img src="{{asset('backend/images/logo-full.png')}}" class="img-fluid" alt="logo"></a>
